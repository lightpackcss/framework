/*
 * Lightpack JS Library
 * -------------------
 * Usage:
 *   1. Include this file after your HTML.
 *   2. Call Lightpack.initAll() after DOMContentLoaded (or let it auto-init).
 *   3. Or, call Lightpack.initTabs(), Lightpack.initAccordions(), etc. individually.
 *   4. All code is namespaced under window.Lightpack to avoid conflicts.
 */
(function(window) {
  ...
  // Toasts
  let toastId = 0;
  Lightpack.showToast = function(msg, type, sticky, position) {
    const id = ++toastId;
    const pos = position || 'bottom-right';
    const container = document.getElementById('toast-container-' + pos);
    if (!container) return;
